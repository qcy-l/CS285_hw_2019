...
class DQNAgent(object):
    def __init__(self, sess, env, agent_params):
        ...
        self.actor = ArgMaxPolicy(sess, self.critic)# a fairly simple actor which donot require optimization

        lander = agent_params['env_name'] == 'LunarLander-v2'#judge if  this is the lander env
    ...
    def step_env(self):
        ...
        if perform_random_action:
            ...
            # action = self.sess.run([self.critic.act_t_ph],feed_dict={self.critic.obs_t_ph:enc_last_obs})
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        if (self.t > self.learning_starts and \
            ...
            # aha = self.sess.run(self.critic.total_error,feed_dict=feed_dict)
